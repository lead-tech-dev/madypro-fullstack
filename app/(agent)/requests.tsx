...
import { listAbsences } from '../../src/services/api/absences.api';
import { Absence } from '../../src/types/absences';
import { AbsenceRequestForm } from '../../src/components/forms/AbsenceRequestForm';
            ...
            <View key={absence.id} style={styles.item}>
              ...
              {absence.validationComment && (
                <View style={styles.managerBox}>
                  <Text style={styles.managerLabel}>Commentaire superviseur</Text>

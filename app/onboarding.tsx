...
const slides: Slide[] = [
  ...
  },
  {
    ...
    description: 'Signalez vos arrivées et départs pour aider les superviseurs à suivre le terrain.',
    icon: 'check-circle',
    accent: '#0e7c86',
    background: '#e3f4f6',
  },
  {
    ...
    description: 'Recevez les notifications importantes et échangez avec votre superviseur.',
    icon: 'message-square',
    accent: '#b34700',
    background: '#fff2e7',
  },
